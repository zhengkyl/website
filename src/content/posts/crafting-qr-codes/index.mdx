...
description: An interactive explaination of how QR codes work and techniques for rendering artistic QR codes
...
<div className="grid rows-[min-content_1fr_min-content] cols-2 grid-flow-col gap-x-4 font-thin text-xs text-center">
  ...
  <span>
  <Sa href="https://www.flickr.com/photos/19736899@N04/2046534730">Original photo</Sa> by <Sa href="https://www.flickr.com/people/hern42/">Arnaud DG</Sa>, <Sa href="https://creativecommons.org/licenses/by/2.0/">CC BY 2.0</Sa>
  </span>
  ...
  <span>
    <Sa href="https://commons.wikimedia.org/wiki/File:Just_going_to_work_(3509126762).jpg">Original photo</Sa> by <Sa href="https://www.flickr.com/people/erikjohansson78/">erikjohansson</Sa>, <Sa href="https://creativecommons.org/licenses/by/2.0/">CC BY 2.0</Sa>
  </span>
</div>
}
...
There's AI for this too. I recommend reading [the creators' blog post](https://latentcat.com/en/blog/qrcode-controlnet) and [Stable Diffusion QR Code 101](https://antfu.me/posts/ai-qrcode-101). I'll omit examples and leave a poem in their place.

{

  <div className="mx-auto -indent-2 text-xs leading-loose font-serif">
...
The design tool I made is available at [qrframe.kylezhe.ng](https://qrframe.kylezhe.ng). It comes with presets that are simple to modify or create from scratch using Javascript.
...
## Turning An Image Into QR Squares

### Overlaying Data Pixels
...
## Turning QR Squares Into An Image
...
### Padding Solving For Fixed Error Correction
