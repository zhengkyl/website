...
subtitle: A deep dive into QR code art
description: An interactive explaination of how QR codes work and every single technique for generating artistic QR codes
tags: ["recommended", "the arts", "the sciences"]
posted: 2024-09-27
edited: 2025-08-22
image: crafting.jpg
---
...
QR codes have invaded our world. Their prolific penetration
is no surprise. They store information efficiently, scan fast and reliably, and
now that QR code scanning is built-in on most phone cameras, there is nothing
that even comes close to their convenience.
...
It's available at [qrframe.kylezhe.ng](https://qrframe.kylezhe.ng), but it's more of a tool for crafting QR codes. It comes with presets that are simple to modify or create from scratch, because it's just Javascript that generates an SVG or renders to an HTML canvas.
...

{
  ...
  <div className="grid cols-1 sm:cols-4 gap-2 pixelated py-2">
    ...
    <p className="sm:col-span-3 pb-8 sm:py-2">
      URLs can have anchors like <Code code="test.com#anchor" inline/>. Usually, this scrolls to a specific part of a page, but an invalid anchor is just ignored. The math used to manipulate pixels by adding an anchor is covered in <a href="https://research.swtch.com/qart">QArt Codes</a>.
    </p>
    <div className="font-thin text-xs text-center">
...
If you'd like to design a QR code, and you're not afraid of writing a little code, give [qrframe.kylezhe.ng](https://qrframe.kylezhe.ng) a try.
