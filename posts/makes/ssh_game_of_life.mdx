...
<details>
<summary className="font-bold">Learn more about the workshop</summary>
...
This is where the [`wish`](https://github.com/charmbracelet/wish) library, also made by @charm, came in handy. It handles ssh connections and even comes with built in middleware for [`bubbletea`](https://github.com/charmbracelet/bubbletea) applications.
