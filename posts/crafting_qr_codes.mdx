...
<div className="grid rows-[min-content_1fr_min-content] cols-2 grid-flow-col gap-x-4 font-thin text-xs text-center">
  ...
  <img className="w-full" src="escape.jpg" alt="me escaping from a train full of salarymen with qr code faces"/>
  <span>
  ...
  <img className="w-full" src="station.jpg" alt="rush hour in train station where salarymen have qr code faces"/>
  <span>
...

{
  <div className="grid cols-2 sm:cols-4 gap-2">
    <img className="w-full" src="logo/in_mcdonalds.jpg" alt="mcdonalds app"/>
    <img className="w-full" src="logo/sf_uber.jpg" alt="uber ad"/>
    <img className="w-full" src="logo/duolingo.jpg" alt="duolingo profile"/>
    <img className="w-full" src="logo/instagram.svg" alt="instagram profile"/>
  </div>
}
...

{
  <div className="grid cols-2 sm:cols-4 gap-2 font-thin text-xs text-center pixelated">
    <div>
      <img className="w-full" src="image/qart_go.png" alt="golang mascot qart code"/>
      <Sa href="https://research.swtch.com/qart">QArt Codes</Sa>
    </div>
    <div>
      <img className="w-full" src="image/halftone_einstein.png" alt="halftone einstein qr code"/>
      <Sa href="https://cgv.cs.nthu.edu.tw/projects/Recreational_Graphics/Halftone_QRCodes">Halftone QR Codes, 2013</Sa>
    </div>
    <div>
      <img className="w-full" src="image/qrpicture_awesome.png" alt="awesome face qr code"/>
      <Sa href="https://github.com/xyzzy/qrpicture">QRpicture</Sa>
    </div>
    <div>
      <img className="w-full" src="image/overlay_burger_king.jpg" alt="burger king ad qr code"/>
...

{
  <div className="grid cols-2 sm:cols-4 gap-2 font-thin text-xs text-center pixelated">
    <div>
      <img className="w-full" src="bespoke/qrcanvas.jpg" alt="qrcanvas"/>
      <Sa href="https://qrcanvas.nl">QRcanvas</Sa>
    </div>
    <div>
      <img className="w-full" src="bespoke/amicollective.png" alt="amicollective"/>
    ...
    <div>
      <img className="w-full" src="bespoke/minor.png" alt="minor"/>
      minor<br/>
      (<Sa href="https://dribbble.com/minorart/shots">Dribbble</Sa>, <Sa href="https://www.behance.net/739019620c2bc">Behance</Sa>)
    </div>
    <div>
      <img className="w-full" src="bespoke/elkoy.png" alt="elkoy artists collective"/>
...

{
  <div className="grid cols-2 gap-2 font-thin text-xs text-center">
    <div>
      <img className="w-full" src="qrbtf/sp1.svg" alt="blocky design"/>
      Created using <Sa href="https://qrbtf.com">QRBTF</Sa>
    </div>
    <div>
      <img className="w-full" src="qrbtf/sp2.svg" alt="bubble design"/>
      Created using <Sa href="https://qrbtf.com">QRBTF</Sa>
    </div>
  </div>
}
...
{
  <div className="grid cols-2 sm:cols-4 gap-2">
    <img className="w-full" src="qrframe/stained_glass.svg" alt="stained glass"/>
    <img className="w-full" src="qrframe/quantum.svg" alt="physics"/>
    <img className="w-full" src="qrframe/whiteboard.png" alt="whiteboard marker"/>
    <img className="w-full" src="qrframe/neon.svg" alt="neon sign"/>
    <img className="w-full" src="qrframe/layers.svg" alt="layered patterns"/>
    <img className="w-full" src="qrframe/tile.png" alt="bathroom tile"/>
    <img className="w-full" src="qrframe/dots.svg" alt="benday dots"/>
    <img className="w-full" src="qrframe/mondrian.svg" alt="abstract art"/>
  </div>
}
...

{
  <div className="grid cols-2 gap-4 font-thin text-xs text-center">
    <div>
      <img className="w-full" src="stencil_1.jpg" alt="bad qr code stencil"/>
      Attempt 1 (terrible)
    </div>
    <div>
      <img className="w-full" src="stencil_2.jpg" alt="slightly better qr code stencil"/>
...

{
  <div className="grid cols-1 sm:cols-2 gap-2 pixelated">
    ...
    <div className="font-thin text-xs text-center ">
      <img className="w-full" src="barcode.png" alt="normal barcode"/>
...

{
  <div className="grid cols-1 sm:cols-4 gap-2 pixelated py-2">
    <div className=" font-thin text-xs text-center">
      <img className="w-full" src="mike/amzqr.jpg" alt="mike wazowski amzing qr code"/>
    ...
    <div className=" font-thin text-xs text-center">
      <img className="w-full" src="mike/visualead.jpg" alt="mike wazowski visualead qr code"/>
    ...
    <div className=" font-thin text-xs text-center">
      <img className="w-full" src="mike/halftone.png" alt="mike wazowski halftone qr code"/>
    ...
    <div className="font-thin text-xs text-center">
      <img className="w-full" src="mike/micrography.png" alt="mike wazowski micrography qr code"/>
    ...
    <div className="font-thin text-xs text-center">
      <img className="w-full" src="image/overlay_bad_apple.jpg" alt="overlay bad apple video qr code"/>
...

{
  <div className="grid cols-1 sm:cols-4 gap-2 pixelated py-2">
    <div className="font-thin text-xs text-center">
      <img className="w-full" src="mike/qart.png" alt="mike wazowski qart code"/>
    ...
    <div className="font-thin text-xs text-center">
      <img className="w-full" src="mike/myqrart.svg" alt="mike wazowski my qr art code"/>
    ...
    <div className="font-thin text-xs text-center">
      <img className="w-full" src="mike/qrpicture.jpg" alt="mike wazowski qr picture"/>
...
and Its Applications, 2011</a>.)
    ...
    <div className="font-thin text-xs text-center">
      <img className="w-full" src="image/reverse_bad_apple.jpg" alt="reverse bad apple video qr code"/>
...
<div className="grid cols-2 gap-2">
  <div className="font-thin text-xs text-center">
    <img className="w-full" src="image/unscannable_bad_apple.png" alt="unscannable bad apple video qr code"/>
    <Sa href="https://youtu.be/1ems029Rln4">Bad Apple but it's an unscannable QR code</Sa>
  </div>
  <div className="font-thin text-xs text-center">
    <img className="w-full" src="image/scannable_bad_apple.png" alt="scannable bad apple video qr code"/>
...

{
  <div className="grid cols-2 gap-2 font-thin text-xs text-center pixelated">
    <div>
      <img className="w-full" src="nonimage/coupland.jpg" alt="douglas coupland qr code"/>
      <Sa href="https://coupland.com">Douglas Coupland</Sa> <span className="whitespace-pre">QR Boogie-Woogie No. 5</span>
    </div>
    <div>
      <img className="w-full" src="qrframe/coupland.png" alt="coupland forgery"/>
...

{
  <div className="grid cols-2 gap-2 font-thin text-xs text-center pixelated">
    <div>
      <img className="w-full" src="nonimage/qrarts.jpg" alt="qrarts qr code"/>
      <Sa href="https://web.archive.org/web/20140103162236/http://qrarts.com/">QrArts</Sa>
    </div>
    <div>
      <img className="w-full" src="qrframe/qrarts.png" alt="qrarts forgery"/>
      Created using <Sa href="https://qrframe.kylezhe.ng">qrframe</Sa>
    </div>
  </div>
}
...

{
  <div className="grid cols-2 gap-2 font-thin text-xs text-center pixelated">
    <div>
      <img className="w-full" src="nonimage/qrbtf.svg" alt="a2c qrbtf code"/>
      <Sa href="https://qrbtf.com/en/style/a2c">QRBTF A2C Style</Sa>
    </div>
    <div>
      <img className="w-full" src="qrframe/qrbtf.svg" alt="a2c qrbtf forgery"/>
      Created using <Sa href="https://qrframe.kylezhe.ng">qrframe</Sa>
    </div>
  </div>
}
...

{
  <div className="grid cols-2 gap-2 font-thin text-xs text-center pixelated">
    <div>
      <img className="w-full" src="stencil_0.jpg" alt="badly drawing qr code with chalk"/>
      Pathetic human attempt
    </div>
    <div>
      <img className="w-full" src="qrframe/chalk.jpg" alt="chalk qr code using roughjs"/>
      Created using <Sa href="https://qrframe.kylezhe.ng">qrframe</Sa>
    </div>
  </div>
}
...

{
  <div className="grid cols-2 gap-2 font-thin text-xs text-center pixelated">
    <div>
      <img className="w-full" src="nonimage/mosaic.jpg" alt="elephant mosaic"/>
      Mosaic inside the Vatican museum
    </div>
    <div>
      <img className="w-full" src="qrframe/mosaic.svg" alt="mosaic qr code"/>
      Created using <Sa href="https://qrframe.kylezhe.ng">qrframe</Sa>
    </div>
  </div>
}
...

{
  <div className="grid cols-2 gap-2 font-thin text-xs text-center pixelated">
    <div>
      <img className="w-full" src="nonimage/waves.jpg" alt="waves on a rocky beach"/>
      The Mediterranean Sea
    </div>
    <div>
      <img className="w-full" src="nonimage/waves.gif" alt="animated waves qr code"/>
...
3. Proprietary scannable codes are kinda funny. Tiktok, Snapchat, and Instagram have already replaced their custom codes (TikCode, Snapcode, Nametag, respectively) with stylized QR codes. ![four proprietary scan codes](four_horsemen.png)
4. Here are links I don't want to lose.
    ...
    <img className="m-auto" src="sf_book.jpg" alt="qr code on book cover"/> 
