...
While we no longer have to use random QR code scanner apps, the tradeoff is that smartphone camera apps are not dedicated QR code scanners.

 They don't even attempt to scan until after a QR code is detected using computer vision.
...
My second mistake was not at all understanding where I needed precision and where I could cut corners. For my first chalk drawing, I even drew the finder patterns freehand.
