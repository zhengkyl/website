...
<div className="grid cols-2 gap-2">
  <div className="font-thin text-xs text-center">
    <img src="image/unscannable_bad_apple.png" alt="unscannable bad apple video qr code"/>
    <Sa href="https://youtu.be/1ems029Rln4">Bad Apple but it's an unscannable QR code</Sa>
  </div>
  <div className="font-thin text-xs text-center">
    <img src="image/scannable_bad_apple.png" alt="scannable bad apple video qr code"/>
...

{
  <div className="grid cols-2 gap-2 font-thin text-xs text-center pixelated">
    <div>
      <img src="stencil_0.jpg" alt="badly drawing qr code with chalk"/>
      Pathetic human attempt
    </div>
    <div>
      <img src="qrframe/chalk.jpg" alt="chalk qr code using roughjs"/>
      Created using <Sa href="https://qrframe.kylezhe.ng">qrframe</Sa>
    </div>
  </div>
}
