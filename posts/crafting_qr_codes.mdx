---
posted: 2024-9-12
desc: The dangers of unemployment
image: crafting.jpg
---
...
Feel free to play with it, but if you have the time, I'd like to share with you everything I learned about QR codes along the way.
...

{
  <div className="grid cols-1 sm:cols-4 gap-2 pixelated py-2">
    ...
    <p className="sm:col-span-3 pb-8 sm:py-2">
      In the simplest case, you can just place dots over the center of each pixel. A dot at least 1/3 the width and height of a pixel is usually enough for it to decode properly.
    </p>
    <div className=" font-thin text-xs text-center">
...

{
  <div className="grid cols-1 sm:cols-4 gap-2 pixelated py-2">
    ...
    <p className="sm:col-span-3 pb-8 sm:py-2">
      URLs can have anchors like <Code>test.com#anchor</Code>. Usually, this scrolls to a specific part of a page, but an invalid anchor is just ignored. The math used to manipulate pixels with these anchors is covered in <a href="https://research.swtch.com/qart">QArt Codes</a>.
    </p>
    <div className="font-thin text-xs text-center">
    ...
    <p className="sm:col-span-3 pb-8 sm:py-2">
      Reverse engineering the data for every "frame" is a bit more difficult, and the QR code is unlikely to be scannable.
    </p>
  </div>
}
...
This is where I'll cover the strategies I've used.

### Forgery

{
  <div className="grid cols-4 gap-2 font-thin text-xs text-center pixelated">
    <div>
...
https://www.youtube.com/watch?v=iX7iGd36NEg
...

{
  <div className="grid cols-4 gap-2 font-thin text-xs text-center pixelated">
    <div>
      <img src="nonimage/waves.jpg" alt="beach"/>
    </div>
    <div>
