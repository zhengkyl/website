---
subtitle: We're making bespoke motherfuckas
posted: 2024-9-12
---
...
Brands have already figured out that you can slap a logo in the center and rely on the error correction algorithm to recover missing data.

{
  <div className="grid cols-4 gap-2">
    <img src="in_mcd.jpg" alt="mcdonalds app"/>
    <img src="sf_uber.jpg" alt="uber ad"/>
    <img src="duo.jpg" alt="duolingo profile"/>
    <img src="insta.svg" alt="instagram profile"/>
  </div>
}

There have been many attempts to create "artistic" QR codes, which overwhelmingly focus on creating images within the code's confines. Some techniques use the pixel grid, some work around it, and the most recent breakthroughs involve using generative AI to turn QR codes into beautiful pictures.

I believe there's a different path we can take to creating QR code art.

{
  <div className="grid cols-4 gap-2">
    <img src="stained_glass.svg" alt="stained glass"/>
    <img src="quantum.svg" alt="physics"/>
    <img src="whiteboard.png" alt="whiteboard marker"/>
    <img src="neon.svg" alt="neon sign"/>
    <img src="layers.svg" alt="layered patterns"/>
    <img src="tile.png" alt="bathroom tile"/>
    <img src="dots.svg" alt="benday dots"/>
    <img src="mondrian.svg" alt="abstract art"/>
  </div>
}

First, I'll teach you how QR codes work, and all the techniques for creating QR code art. Then I'll show you my little project to put it all together, a web app to create these QR codes, available at [qrframe.kylezhe.ng](https://qrframe.kylezhe.ng).
...
{
<div className="grid cols-2 sm:cols-4 gap-4 font-thin text-xs text-center">
  <div>
