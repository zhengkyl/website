...
## Making Artistic QR Codes

Put simply, the finder patterns must be the right shape, while the rest of the QR code just needs to be dark or light enough in the right place.
...

{
  <div className="grid cols-2 gap-4 font-thin text-xs text-center">
    <div>
      ...
      Poorly handdrawn finder patterns
    </div>
    <div>
